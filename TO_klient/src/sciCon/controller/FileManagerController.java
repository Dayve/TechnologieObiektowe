...
public class FileManagerController implements Controller {
	...
	// Those FileInfo objects contain fileIDs, as opposed to those created from local files
	...
	@FXML public void initialize() {
		...
		downloadFileButton.setOnAction(
	            	...
	            	if(chosenRow != null) {
		    			...
		    			Platform.runLater(new Runnable() {
		    				@Override public void run() {
		    					openDialogBox(fileManagerWindow, "Musisz wybrać plik do pobrania. Żaden plik nie jest zaznaczony");
		    				}
		    			});
		            }
		        }
		    ...
		    new EventHandler<ActionEvent>() {
		        ...
		        public void handle(final ActionEvent e) {
	            	...
	            	if(chosenRow != null) {
		    			...
		    			Platform.runLater(new Runnable() {
		    				@Override public void run() {
		    					openDialogBox(fileManagerWindow, "Musisz wybrać plik do usunięcia. Żaden plik nie jest zaznaczony");
		    				}
		    			});
		            }
		        }
